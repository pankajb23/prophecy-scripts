...
retry helm upgrade -i cp prophecy/prophecy --version 0.14.4 -f values_cp.yaml -n cp --set prophecy.enablePathBasedRouting=true --set monitoring.enabled=true
retry helm upgrade -i dp prophecy/prophecy-dataplane --version 0.14.4 -f values_dp.yaml -n dp --set dataplane.enablePathBasedRouting=true --set monitoring.enabled=true
